...
# docker build -f deepks-core-depends.dockerfile -t benndrucker/deepks-core-depends:VERSION -t benndrucker/deepks-core-depends:latest .

# Then build for multiple architectures...
# docker buildx build -f deepks-core-depends.dockerfile --platform linux/arm64,linux/amd64 --load -t benndrucker/deepks-core-depends:VERSION -t benndrucker/deepks-core-depends:latest .